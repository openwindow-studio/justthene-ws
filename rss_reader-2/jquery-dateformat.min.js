  ...
  DateFormat.format = (function () {
    ...
    function i(e) {
      var a,
        ...
        i = "";
      return (
        -1 !== o.indexOf(".") && ((o = (n = o.split("."))[0]), (i = n[n.length - 1])),
        3 <= (s = o.split(":")).length
          ? ((a = s[0]),
            (r = s[1]),
            (t = s[2].replace(/\s.+/, "").replace(/[a-z]/gi, "")),
            { time: (o = o.replace(/\s.+/, "").replace(/[a-z]/gi, "")), hour: a, minute: r, second: t, millis: i })
    ...
    return {
      parseDate: function (e) {
        var a,
          r,
          t = { date: null, year: null, month: null, dayOfMonth: null, dayOfWeek: null, time: null };
        ...
        if ("function" == typeof e.getFullYear)
          ...
          (a = e.split(/[T\+-]/)), (t.year = a[0]), (t.month = a[1]), (t.dayOfMonth = a[2]), (t.time = i(a[3].split(".")[0]));
        else
          switch ((6 === (a = e.split(" ")).length && isNaN(a[5]) && (a[a.length] = "()"), a.length)) {
            case 6:
            ...
            case 10:
              ...
              var n = parseInt(a[1]),
                s = parseInt(a[2]);
              n && !s ? ((t.month = o(a[2])), (t.dayOfMonth = a[1])) : ((t.month = o(a[1])), (t.dayOfMonth = a[2])),
                (t.time = i(a[4]));
              break;
            case 1:
              (r = a[0].split("")),
                ...
                (t.time = i(r[13] + r[14] + r[15] + r[16] + r[17] + r[18] + r[19] + r[20]));
              break;
            default:
              return null;
          }
        return (
          t.time
            ? (t.date = new Date(t.year, t.month - 1, t.dayOfMonth, t.time.hour, t.time.minute, t.time.second, t.time.millis))
      ...
      date: function (a, e) {
        try {
          ...
          if (null === r) return a;
          for (
            var t, n = r.year, s = r.month, o = r.dayOfMonth, i = r.dayOfWeek, u = r.time, c = "", h = "", l = "", m = !1, y = 0;
            y < e.length;
            y++
          ) {
            var d = e.charAt(y),
